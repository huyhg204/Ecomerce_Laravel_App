...
const AdminUsers = () => {
  ...
  const handleRestore = async (id) => {
    try {
      // Optimistic update: Cập nhật UI ngay lập tức (nếu có status field)
      // Nếu không có status field, chỉ refresh sau khi thành công
                ...
                <tr>
                  <td colSpan="8" style={{ 
                    ...
                    <div style={{
                      ...
                      <p style={{ margin: 0 }}>Đang tải danh sách người dùng...</p>
                    </div>
                  </td>
                </tr>
