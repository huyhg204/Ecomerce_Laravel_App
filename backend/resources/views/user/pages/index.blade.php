      ...
      <div class="col-md-12">
        ...
        <div class="category-carousel swiper">
          <div class="swiper-wrapper">
            ...
            <a href="/category/{{$item->id}}" class="nav-link category-item swiper-slide">
              <img width="100%" height="100px" src="{{$item->image_category}}" alt="Category Thumbnail">
              <h3 class="category-title">{{$item->name_category}}</h3>
            </a>
            @endforeach
          </div>
        </div>
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="bootstrap-tabs product-tabs">
          <div class="tabs-header d-flex border-bottom my-5">
            <h3 style="width:30%">Sản phẩm xu thế</h3>
            <nav style="width:70%">
              <div class="nav nav-tabs" id="nav-tab" role="tablist">
                @foreach ($CategoriesHeader as $index => $item)
                @if ($index == 0)
                <a href="#" class="nav-link text-uppercase fs-6 active" id="nav-{{$item->id}}-tab"
                  data-bs-toggle="tab" data-bs-target="#nav-{{$item->id}}">{{$item->name_category}}</a>
                @else
                <a href="#" class="nav-link text-uppercase fs-6" id="nav-{{$item->id}}-tab"
                  data-bs-toggle="tab" data-bs-target="#nav-{{$item->id}}">{{$item->name_category}}</a>
                @endif
                @endforeach
              </div>
          ...
          <div class="tab-content" id="nav-tabContent">
            ...
            <div class="tab-pane fade show active" id="nav-{{$item->id}}" role="tabpanel" aria-labelledby="nav-{{$item->id}}-tab">
              <div class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5">
                @foreach ($productTrending as $index1 => $item1)
                @if ($item->id==$index1)
                @foreach ($item1 as $item2)
                <div class="col">
                  <div class="product-item swiper-slide">
                    <figure>
                      <a href="/product/{{ $item2->product_id}}" title="Product Title">
                        <img width="100%"
                          src="{{ $item2->image_product ?? 'https://via.placeholder.com/300x300?text=No+Image' }}"
                          class="tab-image">
                      </a>
                    </figure>
                    <h3>{{ $item2->name_product }}</h3>
                    <span class="qty">1 phần
                      <span class="price">{{ number_format($item2->price_product, 0, ',', '.') . ' ₫'}}</span>
                  </div>
                </div>
                @endforeach
                @endif
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="banner-ad bg-danger mb-3"
          style="background: url('https://tse1.mm.bing.net/th?id=OIP.B5Zf_o5dLd_-1Of_ch5FgAHaEu&pid=Api&P=0&h=180''');background-repeat: no-repeat;background-position: right bottom;">
          <div class="banner-content p-5">

            <h3 class="banner-title">Thịt bò Úc</h3>
            <p>Thịt bò tươi, chất lượng cao, nhập khẩu từ Úc, đóng gói 500g.</p>
            <a href="/product/4" class="btn btn-dark text-uppercase">Mua ngay</a>
      ...
      <div class="col-md-6">
        <div class="banner-ad bg-info"
          style="background: url('https://tse4.mm.bing.net/th?id=OIP.n-44hhUxVjneMdiHBHUQ-wHaHa&pid=Api&P=0&h=180''');background-repeat: no-repeat;background-position: right bottom;">
          <div class="banner-content p-5">

            <h3 class="banner-title">Thịt gà ta</h3>
            <p>Thịt gà ta tươi, chất lượng cao, nuôi tự nhiên, đóng gói 1kg.</p>
            <a href="/product/5" class="btn btn-dark text-uppercase">Mua ngay</a>
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="section-header d-flex flex-wrap justify-content-between my-5">
          ...
          <div class="d-flex align-items-center">
            <div class="swiper-buttons">
              <button class="swiper-prev products-carousel1-prev btn btn-primary">❮</button>
              <button class="swiper-next products-carousel1-next btn btn-primary">❯</button>
            </div>
          </div>
        </div>
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="products-carousel1 swiper">
          <div class="swiper-wrapper">

            @foreach ($topSellingProducts as $item)
            <div class="product-item swiper-slide">
              <figure>
                <a href="/product/{{ $item->id}}" title="Product Title">
                  <img width="100%"
                    src="{{ $item->image_product ?? 'https://via.placeholder.com/300x300?text=No+Image' }}"
                    class="tab-image">
                </a>
              </figure>
              <h3>{{ $item->name_product }}</h3>
              <span class="qty">Đã bán {{ $item->total_sold }} phần
                <span class="price">{{ number_format($item->price_product, 0, ',', '.') . ' ₫'}}</span>
            </div>
            @endforeach
  ...
  <div class="container-fluid">
      ...
      <div class="col-md-12">
        ...
        <div class="section-header d-flex justify-content-between">
          ...
          <div class="d-flex align-items-center">
            <a href="#" class="btn-link text-decoration-none">View All Categories →</a>
            <div class="swiper-buttons">
              <button class="swiper-prev products-carousel2-prev btn btn-primary">❮</button>
              <button class="swiper-next products-carousel2-next btn btn-primary">❯</button>
            </div>
          </div>
        </div>
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="products-carousel2 swiper">
          <div class="swiper-wrapper">
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="section-header d-flex justify-content-between">
          ...
          <h2 class="section-title">Hàng mới nhập</h2>

          <div class="d-flex align-items-center">
            <div class="swiper-buttons">
              <button class="swiper-prev products-carousel3-prev btn btn-primary">❮</button>
              <button class="swiper-next products-carousel3-next btn btn-primary">❯</button>
            </div>
          </div>
        </div>
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="products-carousel3 swiper">
          <div class="swiper-wrapper">
            @foreach ($productJustArrived as $item)
            <div class="product-item swiper-slide">
              <figure>
                <a href="/product/{{ $item->id}}" title="Product Title">
                  <img width="100%"
          ...
          <div class="row">
            ...
            <div class="col-md-10">
              <div class="card-body p-0">
                ...
                <p class="card-text">Giao hàng nhanh chóng và miễn phí cho tất cả các đơn hàng trong phạm vi nội thành.
                </p>
              </div>
            </div>
          </div>
      ...
      <div class="col">
        <div class="card mb-3 border-0">
          <div class="row">
            ...
            <div class="col-md-10">
              <div class="card-body p-0">
                <h5>Thanh toán 100% an toàn</h5>
                <p class="card-text">Chúng tôi đảm bảo mọi giao dịch thanh toán đều được mã hóa và bảo mật tuyệt đối.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-md-10">
              <div class="card-body p-0">
                ...
                <p class="card-text">Mỗi sản phẩm của chúng tôi đều được kiểm tra chất lượng nghiêm ngặt trước khi đến
                  tay khách hàng.</p>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-md-10">
              <div class="card-body p-0">
                ...
                <p class="card-text">Chúng tôi cam kết mang đến cho bạn những ưu đãi và tiết kiệm vượt trội khi mua sắm.
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="card mb-3 border-0">
          <div class="row">
            <div class="col-md-2 text-dark">
              <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24">
                <path fill="currentColor"
                  d="M18 7h-.35A3.45 3.45 0 0 0 18 5.5a3.49 3.49 0 0 0-6-2.44A3.49 3.49 0 0 0 6 5.5A3.45 3.45 0 0 0 6.35 7H6a3 3 0 0 0-3 3v2a1 1 0 0 0 1 1h1v6a3 3 0 0 0 3 3h8a3 3 0 0 0 3-3v-6h1a1 1 0 0 0 1-1v-2a3 3 0 0 0-3-3Zm-3.5-1a1.5 1.5 0 1 1 3 0a1.5 1.5 0 0 1-3 0ZM6 7a1.5 1.5 0 1 1 3 0a1.5 1.5 0 0 1-3 0ZM5 13v6a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-6h-3v5a1 1 0 0 1-1 1H9a1 1 0 0 1-1-1v-5h-3Zm16-3h-3V8.6a1.5 1.5 0 0 0-2.98-.4L15.6 8a1 1 0 0 0-1.6 1.2l1.08 1.3h-2.03L14.2 9.2a1 1 0 0 0-1.8-1.1l-1 1.6a1.9 1.9 0 0 0 .05-.2h-3.5a1 1 0 0 0 0 2H4a1 1 0 0 0 1-1v3a4 4 0 0 1 2 3h2.5Z" />
              </svg>
            </div>
            <div class="col-md-10">
              <div class="card-body p-0">
                <h5>Đảm bảo sự hài lòng</h5>
                <p class="card-text">Mỗi khách hàng là tài sản quý giá của chúng tôi, và chúng tôi luôn cố gắng làm hài
                  lòng bạn.</p>
              </div>
            </div>
          </div>
