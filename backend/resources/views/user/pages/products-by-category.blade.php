    ...
    <div class="row">
        @foreach ($products as $product)
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                {{-- <div class="card product-item-custom h-100">
                    <img src="{{ $product->image_product ?? 'https://via.placeholder.com/300x300?text=No+Image' }}" class="card-img-top" alt="{{ $product->name_product }}">
                    <div class="card-body">
                        <h5 class="card-title">{{ $product->name_product }}</h5>
                        <!-- Anh muốn thêm gì trong item thì chèn ở đây -->
                    </div>
                </div> --}}
